...
onBtnExport() {
  console.log(this.tabledata, 'this.rowData5');
 
  const excludedProperties = ['dispatchDate', 'erpRefNo', 'orderDate','orderID','orderedQty','productName','shippedTillQty','stockItemId','uploadedDate'];
  ...
  link.href = url;
  link.download = 'Shipments Invoices.xlsx';
  link.click();
