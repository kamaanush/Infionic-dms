...
export class InvoiceComponent implements OnInit {
  ...
  constructor(
    ...
    private uomservise: OrdersApisService,
  ...
  getusertabeldata() {
    ...
    this.uomservise.GetShipmentsUploadList(data).subscribe((res: any) => {
  ...
  roleItems() {
    this.user.getroleDetails().subscribe((res: any) => {
      ...
      this.toppingList = localdata.map(
        (data: { designationId: any; designationName: any }) => {
          return {
            role_id: data.designationId,
            role_name: data.designationName,
          };
        }
      );
  ...
  onCellClicked(e): void {
    ...
    localStorage.setItem('guid',JSON.stringify(e.data.id))
