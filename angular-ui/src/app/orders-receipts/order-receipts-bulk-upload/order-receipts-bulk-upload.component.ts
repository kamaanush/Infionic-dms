  ...
  this.uploadedTextShow=true;
    ...
    reader.onload = (e: any) => {
      ...
      //  console.log( this.totalRows,"check total rows");
        ...
        this.incorrectRows = this.TargetUpload.incorrectRows;
// console.log("InCoreeeeect",this.TargetUpload)
      ...
      // console.log("incorret data checking " ,  this.TargetUpload=res.response.incorrectRows);
